...
Define versions.
*/
define ("WS_WIDGET__AD_CODES_VERSION", "2.1");
define ("WS_WIDGET__AD_CODES_MIN_PHP_VERSION", "5.2");
define ("WS_WIDGET__AD_CODES_MIN_WP_VERSION", "3.0");
define ("WS_WIDGET__AD_CODES_MIN_PRO_VERSION", "1.0");
/*
...
if (version_compare (PHP_VERSION, WS_WIDGET__AD_CODES_MIN_PHP_VERSION, ">=") && version_compare (get_bloginfo ("version"), WS_WIDGET__AD_CODES_MIN_WP_VERSION, ">=") && !isset ($GLOBALS["WS_WIDGET__"]["ad_codes"]))
	{
		...
		*/
		if (apply_filters ("ws_widget__ad_codes_load_pro", true))
...
else if (is_admin ()) /* Admin compatibility errors. */
	{
		if (!version_compare (PHP_VERSION, WS_WIDGET__AD_CODES_MIN_PHP_VERSION, ">="))
			{
				add_action (( (version_compare (get_bloginfo ("version"), "3.1-RC", ">=")) ? "all_admin_notices" : "admin_notices"), create_function ('', 'echo \'<div class="error fade"><p>You need PHP v\' . WS_WIDGET__AD_CODES_MIN_PHP_VERSION . \'+ to use the Ad Codes widget.</p></div>\';'));
			}
		else if (!version_compare (get_bloginfo ("version"), WS_WIDGET__AD_CODES_MIN_WP_VERSION, ">="))
			{
				add_action (( (version_compare (get_bloginfo ("version"), "3.1-RC", ">=")) ? "all_admin_notices" : "admin_notices"), create_function ('', 'echo \'<div class="error fade"><p>You need WordPress® v\' . WS_WIDGET__AD_CODES_MIN_WP_VERSION . \'+ to use the Ad Codes widget.</p></div>\';'));
			}
	}
?>