...
/**/
if (!class_exists ("c_ws_widget__ad_codes_utils_css"))
	{
		class c_ws_widget__ad_codes_utils_css
			{
				/*
				...
				public static function compress_css ($css = FALSE)
					{
						...
						$css = preg_replace ("/;\}/", "}", $css);
						/**/
						return preg_replace_callback ($c6, "c_ws_widget__ad_codes_utils_css::_compress_css_c3", $css);
					}
